...
<style>
  ...
  <div class="grid">
    <div class="left">
      ...
      <div class="box">
        <h3>Вознаграждение экспедитора, декларанта и технического импортера</h3>
        <table class="t">
          <tr>
          ...
          <tr>
            <td>Агентская комиссия по подбору O/F (Ocean Freight)</td>
            <td style="text-align:right">—</td>
          </tr>
          <tr>
            <td>Оплата на фабрику за клиента (% от стоимости инвойса)</td>
            <td style="text-align:right">—</td>
          </tr>
        </table>
      </div>
